...
public class Segmentations extends AuditableLongBaseEntity implements Comparable<Segmentations> {

    private static final long serialVersionUID = 1L;

    @Column(name = "segmentation", length = 200)
    @NotNull(message = "segmentation can not be empty")
    ...
    @Override
    public int compareTo(Segmentations o) {
