...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    ...
    <body>
        ...
        <div class="bold_header" style="padding-bottom: 10px;">
            ...
            <div class="reportTitle">Assembly Constituency Report</div>
                <div style="font-size:16px; font-weight:bold; padding-bottom: 10px;">Assembly Constituency Number: ${assemblyNumber}</div>
            ...
            <table width="100%">
                <thead>
                    ...
                    <tr     style="background-color: #ffc000; color:#fff; height: 50px !important;">
                        <th style="background-color: #ffffff; color:#000; ">Sr. No</th>
                        <th style="background-color: #595959; ">Ward#</th>
                        ...
                        <th style="background-color: #a6a6a6; width:40px;">Total Houses</th>
                        <th style="background-color: #ffffff; border: 0 ; color:#f2f2f2">&nbsp;</th>
                        <th style="background-color: #a6a6a6; ">Total Voters</th>
                        <th style="background-color: #000000; width:40px;">% Voters Visited</th>
                        <th style="background-color: #ffffff; border: 0 ; color:#f2f2f2">&nbsp;</th>
                        <th style="width:45px;">Voters Visited</th>
                        ...
                        <#list reportData as result>
                            <#if count != (reportData?size)>
                                <tr style="background-color:#fff2cc">
                                    ...
                                    <td style="border-left: 1px solid black; background-color:#f2f2f2"><#if (result[3])??> ${result[3]} <#else>0</#if></td>
                                    
                                    <td style="background-color:#f2f2f2;">${result[4]}</td>
                                    <td style="background-color:#fff;border: 0;">&nbsp;</td>
                                    
                                                             
                                    <td style="border-left: 1px solid black;background-color:#f2f2f2;">${result[6]}</td>
                            ...
                            <#else>
                                <tr style="background-color:#fff2cc">
                                    ...
                                    <#list result as resultData>
                                        <#if ind &gt; 7 && ind != (result?size - 1)>
                                            <#if (result[ind])??>
                                                <td style="border-bottom: 1px solid black;border-left: 1px solid black;border-right: 0;">${result[ind]}</td>
                                            <#else>
                                                <td style="background-color:#fff;border: 0;">&nbsp;</td>
                                            </#if>
                                        </#if>
